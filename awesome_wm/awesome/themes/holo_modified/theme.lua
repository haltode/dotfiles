...
theme.icon_dir                      = os.getenv("HOME") .. "/.config/awesome/themes/holo_modified/icons"

theme.wallpaper                     = os.getenv("HOME") .. "/.config/awesome/themes/holo_modified/mountain.jpe"
...
theme.gap                           = theme.icon_dir .. "/gap.png"
...
theme.layout_uselesstilebottom      = theme.icon_dir .. "/uselesstilebottom.png"
theme.layout_uselesspiral           = theme.icon_dir .. "/spiral.png"
theme.layout_uselessfair            = theme.icon_dir .. "/uselessfair.png"
