...
beautiful.init(os.getenv("HOME") .. "/.config/awesome/themes/holo_modified/theme.lua")
...
-- Tags
tags = {}
tags[1] = awful.tag({" WEB "," OTHER ", " MUSIC/TORRENT ", " MOVIE "}, 1, {layouts[1], layouts[4], layouts[2], layouts[1]})
tags[2] = awful.tag({"  IRC  ", " MAIL/NEWS ", " OTHER ", " CODE "}, 2, {layouts[4], layouts[3], layouts[4], layouts[4]})
...
-- Calendar
mytextcalendar = awful.widget.textclock(markup("#FFFFFF", space3 .. "%a %d %b<span font='Tamsyn 5'> </span>"))
...
gap = wibox.widget.imagebox()
gap:set_image(beautiful.gap)
...
globalkeys = awful.util.table.join(
    ...
    -- Take a screenshot
    awful.key({ altkey,           }, "p", function () awful.util.spawn("xfce4-screenshooter") end),
